...
Proof.
  ...
  - apply nf_is_value in H1. inversion H1 ; subst. exists n. split. reflexivity. constructor.
  - assert (exists n: nat, z = C n /\ y || n). apply IHmulti ; try assumption.
    split ; assumption. inversion H3 ; subst. inversion H4.
    exists x0. split. assumption. apply step__eval with (t' := y) ; assumption.
Qed.
